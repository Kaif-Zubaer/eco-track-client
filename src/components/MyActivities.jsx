...
const MyActivities = () => {
    ...
    const handleEdit = (challenge) => {
      ...
      `,
            showCancelButton: true,
            cancelButtonColor: "#7fba2d",
            confirmButtonText: "Save Changes",
            confirmButtonColor: "#7fba2d",
            focusConfirm: false,
            preConfirm: () => {
                return {
        ...
        <div className="bg-[#f5faf7] py-12 px-4 md:px-8 xl:px-25">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-10">
                    <h2 className="text-3xl md:text-4xl font-bold text-primary mb-3">My Created Challenges</h2>
                    <p className="text-gray-600">Manage the challenges you’ve created for the community.</p>
                </div>
                {
                    createdChallenges.length > 0
                            ...
                            <div className="space-y-4 mb-16">
                                {
                                    createdChallenges.map((ch) => (
                                        <div key={ch._id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 p-5 flex flex-col md:flex-row justify-between items-start md:items-center">
                                            <div className="flex-1">
                                                <h3 className="text-xl font-semibold text-primary mb-2">{ch.title}</h3>
                                                <p className="text-gray-600 text-sm mb-3">{ch.description.slice(0, 120)}...</p>
                                            ...
                                            <div className="mt-4 md:mt-0 flex gap-3">
                                                <button onClick={() => handleEdit(ch)} className="bg-primary text-white py-1 px-3 rounded-md text-sm font-medium">Edit</button>
                                                <button onClick={() => handleDelete(ch._id)} className="bg-red-500 text-white py-1 px-3 rounded-md text-sm font-medium">Delete</button>
                                            </div>
                                        </div>
                                    ))
                                }
                        ...
                        : <p className="text-center text-gray-500 text-lg mb-16">You haven’t created any challenges yet.</p>
                }
                <div className="text-center mb-10">
